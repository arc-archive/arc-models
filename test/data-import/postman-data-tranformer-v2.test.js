...
import { PostmanV2Transformer } from '../../src/transformers/PostmanV2Transformer.js';
...
describe('PostmanV2Transformer', () => {
  describe('readProjectInfo()', () => {
    ...
    beforeEach(async () => {
      const transformer = new PostmanV2Transformer(jsonData);
    ...
    it('has the key', () => {
      assert.equal(result.key, 'c0a9562a-e1a3-5ecd-ef63-a4512f4fce44');
    });
  ...
  describe('Body computation', () => {
    let transformer = /** @type PostmanV2Transformer */ (null);
    let jsonData;
    let item;
