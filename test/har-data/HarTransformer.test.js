...
describe('HarTransformer', () => {
  ...
  describe('createResponseContent()', () => {
    ...
    it('sets the status code', async () => {
      const rsp = generator.generateResponse({ timings: true, ssl: true });
  ...
  describe('createRedirectEntries()', () => {
    ...
    it('returns an array with all responses', async () => {
      ...
      const rsp = generator.generateResponse({ timings: true, ssl: true, redirects: true });
  ...
  describe('createEntry()', () => {
    ...
    it('returns null for error response', async () => {
      const errorResponse = generator.generateErrorResponse();
      const tr = generator.generateTransportRequest();
    ...
    it('returns an array when redirects', async () => {
      ...
      const transportRequest = generator.generateTransportRequest();
      const request = /** @type ArcBaseRequest */ ({
        transportRequest,
        response,
        method: 'GET',
    ...
    it('has the startedDateTime property', async () => {
      const response = generator.generateResponse({ timings: true, ssl: true });
      const transportRequest = generator.generateTransportRequest();
      const request = /** @type ArcBaseRequest */ ({
        transportRequest,
        response,
  ...
  describe('transform()', () => {
    ...
    it('creates entries for multiple requests', async () => {
      ...
      Array(2).fill(0).forEach(() => {
        const response = generator.generateResponse({ timings: true, ssl: true, redirects: true });
        const transportRequest = generator.generateTransportRequest();
        const request = /** @type ArcBaseRequest */ (generator.generateHistoryObject());
